...
tf.app.flags.DEFINE_string('train_directory', './train_L',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', './test_L',
                           'Validation data directory')
tf.app.flags.DEFINE_string('output_directory', './data_prepared/L',
...
def _convert_to_example(filename, image_buffer, label, text, height, width):
    ...
    Args:
      ...
      text: string, unique human-readable, e.g. 'malware'
...
class ImageCoder(object):
    ...
    def __init__(self):
        ...
        self._decode_jpeg = tf.image.decode_jpeg(
            self._decode_jpeg_data, channels=1)
...
def _process_image_files_batch(coder, thread_index, ranges, name, filenames,
    ...
    Args:
      ...
      texts: list of strings; each string is human readable, e.g. 'malware'
