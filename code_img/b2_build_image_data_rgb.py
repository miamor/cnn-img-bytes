...
tf.app.flags.DEFINE_string('train_directory', '../data/train_RGB',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', '../data/test_RGB',
                           'Validation data directory')
tf.app.flags.DEFINE_string('output_directory', './data_prepared/RGB',
